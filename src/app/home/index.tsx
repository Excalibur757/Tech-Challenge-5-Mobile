...
import { Tutorial } from "./components/Tutorial"; // 👈 NOVO IMPORT
...
export default function TodoScreen() {
  ...
  return (
    <>
      {/* 📚 TUTORIAL - Componente que aparece na primeira vez */}
      <Tutorial />
      ...
      >
        ...
        {mode === "completo" && (
          <HistorySummary 
            tasks={tasks} 
            onViewMore={() => {
              console.log("📋 Ver todos os históricos");
            }}
          />
        )}
        ...
        {mode === "completo" && (
          <StatsDisplay stats={stats} styles={styles} dynamicStyles={dynamicStyles} />
        )}
